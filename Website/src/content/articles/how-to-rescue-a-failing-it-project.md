...
description: A structured approach to diagnosing what has gone wrong in a technology programme and building a credible recovery plan. Covers assessment, stakeholder reset and the governance decisions that actually matter.
pubDate: 2025-06-02
category: Recovery
readTime: 7
tags:
...
By the time a programme is formally declared to be in trouble, the problems that caused the crisis are usually six to twelve months old. The immediate trigger - a missed go-live, a budget blowout, a sponsor who has lost confidence publicly - is rarely the root cause.
...
Failing programmes have usually accumulated a backlog of commitments - dates, deliverables, cost estimates, scope items - that were made optimistically or under pressure and cannot actually be met. Each new commitment that is missed erodes a little more of the stakeholder confidence that the recovery depends on.

The hard conversation that must happen early is with the programme sponsor: the current plan is not achievable, so continuing to report against it is making the situation worse. This conversation is difficult, but it is necessary before any other recovery work can proceed.

## Conduct a structured health assessment

Before you can build a recovery plan, you need an honest picture of where the programme actually is. This means working through a structured assessment across five dimensions:
...
**Stakeholder alignment.** Who still has confidence in the programme? Who has lost it? What do the critical stakeholders actually need to see to re-engage? What has damaged their confidence specifically?
...
The output of this assessment is a written finding. Not a set of slides, not a verbal summary, but a written document that sets out the actual state of the programme, the causes of the current situation and what recovery will require. This document becomes the basis for every subsequent conversation.

## Be honest about the options

Recovery planning is not the same as schedule compression. You cannot fix a programme that is twelve months behind schedule and twenty percent over budget by asking the team to work harder or the vendor to reduce their rates.

The honest options are usually three:

**Rescope and replan.** Reduce the programme to what can actually be delivered within the remaining budget and a credible timeframe. This requires decisions about what is in scope and what is not, so those decisions need to be made by the sponsor, not the delivery team.
...
**Stop.** Acknowledge that the programme has failed, close it down in a controlled manner, preserve what value can be preserved and decide whether the underlying business need still exists and how to address it differently.
...
Stakeholder confidence in a failing programme does not recover automatically. It requires a deliberate communication strategy that is different from the normal programme status reporting cycle.

The key elements are:

**Acknowledge what went wrong.** Stakeholders who have been receiving optimistic reports for months are not going to trust a new version of the same reporting unless there is an explicit acknowledgement that the previous reporting was not accurate. This does not mean apportioning blame, but it means being clear that the picture is now being presented accurately.

**Present the honest current state.** Use the health assessment findings. Show the actual delivery position, the actual financial position and the actual risks. Do not soften the findings for the audience.
...
**Define what success looks like now.** The original success criteria for the programme may no longer be achievable. Redefining success is not the same as accepting failure, but is being clear about what the programme can now deliver and why that still has value.

## Governance decisions that matter

Programme recovery requires governance decisions, not just delivery decisions. The delivery team cannot recover a programme without the authority to make the changes that recovery requires.
...
**Resourcing decisions.** Does the programme team have the right people? Are there capability gaps that need to be addressed before the recovery plan can proceed?
...
**Treating the recovery plan as a one-time exercise.** Recovery is a continuous process. The plan needs to be updated as new information becomes available, so the governance structure needs to be able to respond when the plan needs to change.

**Losing the sponsor.** Programme recovery requires executive support. If the sponsor has already decided that the programme is too far gone, the recovery work cannot succeed. Securing the sponsor's genuine commitment before the recovery begins is essential.

---

The Vantage Meridian Project Recovery Pack includes structured templates for health assessment, stakeholder reset communications, recovery roadmap planning and risk re-baselining. See the [Project Recovery Pack](/resources/project-recovery-pack) for details.
