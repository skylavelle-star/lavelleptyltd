...
The financial and commercial offer is typically evaluated separately from the technical and capability assessment and combined at the end. This prevents the price from biasing the capability assessment.
...
The Lavelle Pty Ltd Procurement Pack includes a weighted evaluation scorecard, evaluator guidance, probity checklist, BAFO request template and recommendation report structure. See the [Procurement Pack](/resources/procurement-pack) for details.
